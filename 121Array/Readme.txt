...
and it begins with one or more 1s followed by a one or more 2s and 
then ends with the same number of 1s that it begins with. 

1 1 1 2 2 2 2 1 1 1

Write a method named is121 Array that returns 1, if its array argument is a 121 array, otherwise, it returns 0.
